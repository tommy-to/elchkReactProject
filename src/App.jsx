...
const App = () => {
    ...
    return (
        <Router>
            <div>
                <Switch>
                    <Route exact path="/" render={() => <SearchBar volunteerData={volunteerData} />} />
                    <Route path="/VolunteerDetailsPage/:volunteerId" render={({ match }) => (
                        <VolunteerDetailsPage volunteerId={match.params.volunteerId} volunteerData={volunteerData} />
                    )} />
                </Switch>
            </div>
        </Router>
